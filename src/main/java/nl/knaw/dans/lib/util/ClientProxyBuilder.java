 ...
 * @param <P> the proxy class used by the application to call specific endpoints
 */
@Slf4j
@RequiredArgsConstructor
public class ClientProxyBuilder<A, P> {
    private Supplier<A> apiClientCtor;
    private URI basePath;
    private JerseyClientConfiguration httpClient;
    private Function<A, P> proxyCtor;

    public ClientProxyBuilder<A, P> apiClientCtor(Supplier<A> apiClientCtor) {
        this.apiClientCtor = apiClientCtor;
        return this;
    }
     ...
     *
     * @param basePath the base URI to be used for constructing API endpoints
     * @return the current instance of {@code ClientProxyBuilder<A, D>} for method chaining
     */
     ...
     *
     * @param httpClient the {@link JerseyClientConfiguration} instance defining the HTTP client settings
     * @return the current instance of {@code ClientProxyBuilder<A, D>} to allow method chaining
     */
    public ClientProxyBuilder<A, P> httpClient(JerseyClientConfiguration httpClient) {
     ...
     *
     * @param proxyCtor the P constructor function that takes an instance of A.
     * @return the current instance of {@code ClientProxyBuilder<A, D>} to allow method chaining
     */
    ...
    public P build() {
        ...
        try {
            ...
            return proxyCtor.apply(apiClient);
        }
        catch (Exception e) {
